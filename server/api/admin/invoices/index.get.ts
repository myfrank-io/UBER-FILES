...
import { INVOICE_INCLUDE, loadIssuer, missingIssuerFields, serializeInvoice, suggestNextNumber } from '~/server/utils/invoice'
...
export default defineEventHandler(async (event) => {
  ...
  const [invoices, issuer, drivers, suggestedNumber] = await Promise.all([
